...
def getAcc( pos, mass, G, softening ):
	...
	# matrix that stores all pairs	wise particle separations: r_j - r_i
	dx = x.T - x
	dy = y.T - y
	#dz = z.T - z
...
def main():
	...
	pos  = read_data(16,10)   # randomly selected positions and velocities

	mass_dist= [[0,1.0], [0,0.5], [0,0.4] ,[0,0.32000000000000006], [0,0.25600000000000006], [0,0.20480000000000007] ,[0,0.16384000000000007] ,[0,0.13107200000000005], [0,0.10485760000000005], [0,0.08388608000000004] ,[0,0.06710886400000003]]

	mass=[mass_dist[0]]
	for index in range(1, len(mass_dist)):
		mass.extend([mass_dist[index]]*16)
	...
	grid = plt.GridSpec(3, 1, wspace=0.0, hspace=0.3)#teste
